...
namespace BankID
{
  ...
  /**
   * BankID configuration structure
   * This structure contains the configuration for the BankID API.
   * It includes the end user IP address, optional fields for return URL,
   * return risk, user visible data, app configuration, web configuration,
   * and requirement.
   * It is used to create a BankID session with the specified parameters.
   *
   * The endUserIp is a required field, while the rest are optional.
   * The returnUrl is the URL to which the user will be redirected after authentication.
   */
  ...
  public:
    /**
     * Constructor for BankIDConfig
     * @param endUserIp The IP address of the end user
     * @param sslConfig The SSL configuration for the BankID API
     * @brief Initializes the BankID configuration with the specified end user IP and SSL configuration.
     * This constructor sets the required endUserIp field and initializes the SSLConfig.
     *
     * A simple config can look like this:
     * ```
     * {
    ...
    /**
     * Static factory method to create a simple BankID configuration
     * @param endUserIp The IP address of the end user
     * @param sslConfig The SSL configuration for the BankID API
     * @return A BankIDConfig object with the specified end user IP and SSL configuration.
     */
